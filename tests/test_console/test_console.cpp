...
SCENARIO("Lua options interop")
{
    ...
    GIVEN("A Lua console with default CommandLine values")
    {
        ...
        WHEN("The script \"v = sfoav.getOption(\"meshes\");\"")
        {
            ...
            WHEN("The script \"sfoav.setOption(\"meshes\", true); v = sfoav.getOption(\"meshes\");\"")
            {
                console.runString("sfoav.setOption(\"meshes\", true); v = sfoav.getOption(\"meshes\");");
                THEN("v is true")
                {
        ...
        WHEN("The script \"v = sfoav.getOption(\"hideAtoms\");\"")
        {
            console.runString("v = sfoav.getOption(\"hideAtoms\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"hideAtoms\", true); v = sfoav.getOption(\"hideAtoms\");\"")
            {
                console.runString("sfoav.setOption(\"hideAtoms\", true); v = sfoav.getOption(\"hideAtoms\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"showAxes\");\"")
        {
            console.runString("v = sfoav.getOption(\"showAxes\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"showAxes\", true); v = sfoav.getOption(\"showAxes\");\"")
            {
                console.runString("sfoav.setOption(\"showAxes\", true); v = sfoav.getOption(\"showAxes\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"showCell\");\"")
        {
            console.runString("v = sfoav.getOption(\"showCell\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"showCell\", true); v = sfoav.getOption(\"showCell\");\"")
            {
                console.runString("sfoav.setOption(\"showCell\", true); v = sfoav.getOption(\"showCell\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"play\");\"")
        {
            console.runString("v = sfoav.getOption(\"play\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"play\", true); v = sfoav.getOption(\"play\");\"")
            {
                console.runString("sfoav.setOption(\"play\", true); v = sfoav.getOption(\"play\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"noCentering\");\"")
        {
            console.runString("v = sfoav.getOption(\"noCentering\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"noCentering\", true); v = sfoav.getOption(\"noCentering\");\"")
            {
                console.runString("sfoav.setOption(\"noCentering\", true); v = sfoav.getOption(\"noCentering\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"darkTheme\");\"")
        {
            console.runString("v = sfoav.getOption(\"darkTheme\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"darkTheme\", true); v = sfoav.getOption(\"darkTheme\");\"")
            {
                console.runString("sfoav.setOption(\"darkTheme\", true); v = sfoav.getOption(\"darkTheme\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"noTransparencySorting\");\"")
        {
            console.runString("v = sfoav.getOption(\"noTransparencySorting\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"noTransparencySorting\", true); v = sfoav.getOption(\"noTransparencySorting\");\"")
            {
                console.runString("sfoav.setOption(\"noTransparencySorting\", true); v = sfoav.getOption(\"noTransparencySorting\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"sizeByMass\");\"")
        {
            console.runString("v = sfoav.getOption(\"sizeByMass\");");
            THEN("v is false")
            {
                REQUIRE(console.getGlobal<LuaBool>("v").bit == false);
            }
            WHEN("The script \"sfoav.setOption(\"sizeByMass\", true); v = sfoav.getOption(\"sizeByMass\");\"")
            {
                console.runString("sfoav.setOption(\"sizeByMass\", true); v = sfoav.getOption(\"sizeByMass\");");
                THEN("v is true")
                {
                    REQUIRE(console.getGlobal<LuaBool>("v").bit == true);
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"levelOfDetail\");\"")
        {
            console.runString("v = sfoav.getOption(\"levelOfDetail\");");
            THEN("v is 0")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 0);
            }
            WHEN("The script \"sfoav.setOption(\"levelOfDetail\", 31); v = sfoav.getOption(\"levelOfDetail\");\"")
            {
                console.runString("sfoav.setOption(\"levelOfDetail\", 31); v = sfoav.getOption(\"levelOfDetail\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
            }
        }

        WHEN("The script \"v = sfoav.getOption(\"msaa\");\"")
        {
            console.runString("v = sfoav.getOption(\"msaa\");");
            THEN("v is 0")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 0);
            }
            WHEN("The script \"sfoav.setOption(\"msaa\", 31); v = sfoav.getOption(\"msaa\");\"")
            {
                console.runString("sfoav.setOption(\"msaa\", 31); v = sfoav.getOption(\"msaa\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"speed\");\"")
        {
            ...
            THEN("v is 60")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 60);
            }
            WHEN("The script \"sfoav.setOption(\"speed\", 31); v = sfoav.getOption(\"speed\");\"")
            {
                console.runString("sfoav.setOption(\"speed\", 31); v = sfoav.getOption(\"speed\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"bondCutOff\");\"")
        {
            ...
            WHEN("The script \"sfoav.setOption(\"bondCutOff\", 31); v = sfoav.getOption(\"bondCutOff\");\"")
            {
                console.runString("sfoav.setOption(\"bondCutOff\", 31); v = sfoav.getOption(\"bondCutOff\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"bondSize\");\"")
        {
            console.runString("v = sfoav.getOption(\"bondSize\");");
            THEN("v is 1")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 1);
            }
            WHEN("The script \"sfoav.setOption(\"bondSize\", 31); v = sfoav.getOption(\"bondSize\");\"")
            {
                console.runString("sfoav.setOption(\"bondSize\", 31); v = sfoav.getOption(\"bondSize\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"atomSize\");\"")
        {
            console.runString("v = sfoav.getOption(\"atomSize\");");
            THEN("v is 1")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 1);
            }
            WHEN("The script \"sfoav.setOption(\"atomSize\", 31); v = sfoav.getOption(\"atomSize\");\"")
            {
                console.runString("sfoav.setOption(\"atomSize\", 31); v = sfoav.getOption(\"atomSize\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"globalAtomAlpha\");\"")
        {
            console.runString("v = sfoav.getOption(\"globalAtomAlpha\");");
            THEN("v is 1")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 1);
            }
            WHEN("The script \"sfoav.setOption(\"globalAtomAlpha\", 31); v = sfoav.getOption(\"globalAtomAlpha\");\"")
            {
                console.runString("sfoav.setOption(\"globalAtomAlpha\", 31); v = sfoav.getOption(\"globalAtomAlpha\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"globalBondAlpha\");\"")
        {
            console.runString("v = sfoav.getOption(\"globalBondAlpha\");");
            THEN("v is 1")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 1);
            }
            WHEN("The script \"sfoav.setOption(\"globalBondAlpha\", 31); v = sfoav.getOption(\"globalBondAlpha\");\"")
            {
                console.runString("sfoav.setOption(\"globalBondAlpha\", 31); v = sfoav.getOption(\"globalBondAlpha\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"deemphasisAlpha\");\"")
        {
            console.runString("v = sfoav.getOption(\"deemphasisAlpha\");");
            THEN("v is 0.25")
            {
                REQUIRE(console.getGlobal<LuaNumber>("v").n == 0.25);
            }
            WHEN("The script \"sfoav.setOption(\"deemphasisAlpha\", 31); v = sfoav.getOption(\"deemphasisAlpha\");\"")
            {
                console.runString("sfoav.setOption(\"deemphasisAlpha\", 31); v = sfoav.getOption(\"deemphasisAlpha\");");
                THEN("v is 31")
                {
                    REQUIRE_THAT(console.getGlobal<LuaNumber>("v").n, WithinAbs(31, tol));
                }
        ...
        WHEN("The script \"v = sfoav.getOption(\"profile\");\"")
        {
